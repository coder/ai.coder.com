...
locals {
  anthropic = {
    "global.anthropic.claude-sonnet-4-5-20250929-v1:0" = {
      ...
      allowed_models = [
        "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.anthropic.claude-sonnet-4-5-20250929-v1:0",
    ...
    "global.anthropic.claude-sonnet-4-6" = {
      ...
      allowed_models = [
        "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.anthropic.claude-sonnet-4-6",
    ...
    "global.anthropic.claude-sonnet-5" = {
      ...
      allowed_models = [
        "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.anthropic.claude-sonnet-5",
    ...
    "global.anthropic.claude-haiku-4-5-20251001-v1:0" = {
      ...
      allowed_models = [
        "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.claude-haiku-4-5-20251001-v1:0",
    ...
    "global.anthropic.claude-opus-4-8" = {
      ...
      allowed_models = [
        "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.anthropic.claude-opus-4-8",
    ...
    "global.anthropic.claude-opus-4-7" = {
      ...
      allowed_models = [
        "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.anthropic.claude-opus-4-7",
    ...
    "global.anthropic.claude-opus-4-6-v1" = {
      ...
      allowed_models = [
        "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.anthropic.claude-opus-4-6-v1",
    ...
    "global.anthropic.claude-opus-4-5-20251101-v1:0" = {
      ...
      allowed_models = [
        "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.anthropic.claude-opus-4-5-20251101-v1:0",
...
module "anthropic" {
  ...
  aws_bedrock_allowed_models = concat([
    "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/global.anthropic.claude-haiku-4-5-20251001-v1:0",
    "arn:aws:bedrock:*::foundation-model/anthropic.claude-haiku-4-5-20251001-v1:0"
...
#     "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/openai.gpt-oss-safeguard-120b",
#     "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/openai.gpt-oss-safeguard-20b",
...
#   aws_bedrock_allowed_models = [
#     "arn:aws:bedrock:${var.region}:${data.aws_caller_identity.this.account_id}:inference-profile/amazon.nova-2-lite-v1:0",
